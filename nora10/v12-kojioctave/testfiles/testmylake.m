...
initfile='VAN_init_v12'; % Koji changed 10.11.09 
parafile='VAN_para_v12_1b'; % Koji changed 10.11.09
inputfile='VAN_input_PGS84_00_v12'; % Koji changed 10.11.09

tic
        [zz,Az,Vz,tt,Qst,Kzt,Tzt,Czt,Szt,Pzt,Chlzt,PPzt,DOPzt,DOCzt,lambdazt,...
        His,DoF,DoM,MixStat,Wt]...
           = solvemodel_v12_1k(m_start,m_stop,initfile,'lake',inputfile,'timeseries', parafile,'lake');    
run_time=toc
