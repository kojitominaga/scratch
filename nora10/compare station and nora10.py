...
ta = np.genfromtxt('NORA10/NORA10_1H_11km_ta_2m_1993-2012_mean24_' + 
                   'OsloBlindern_interpolated_cutoff_100_nlocal_50.txt.gz', 
                   dtype = 'f8', names = True)
hur = np.genfromtxt('NORA10/NORA10_1H_11km_hur_2m_1993-2012_mean24_' + 
                   'OsloBlindern_interpolated_cutoff_100_nlocal_50.txt.gz', 
                   dtype = 'f8', names = True)
wss = np.genfromtxt('NORA10/NORA10_1H_11km_wss_10m_1993-2012_mean24_' + 
                   'OsloBlindern_interpolated_cutoff_100_nlocal_50.txt.gz', 
                   dtype = 'f8', names = True)
clt = np.genfromtxt('NORA10/NORA10_1H_11km_clt_1993-2012_mean24_' + 
                   'OsloBlindern_interpolated_cutoff_100_nlocal_50.txt.gz', 
                   dtype = 'f8', names = True)
pr = np.genfromtxt('NORA10/NORA10_1H_11km_pr_1993-2012_mean24_' + 
                   'OsloBlindern_interpolated_cutoff_100_nlocal_50.txt.gz', 
                   dtype = 'f8', names = True)
ps = np.genfromtxt('NORA10/NORA10_3H_11km_ps_1993-2012_mean8_' + 
                   'OsloBlindern_interpolated_cutoff_100_nlocal_50.txt.gz', 
                   dtype = 'f8', names = True)
