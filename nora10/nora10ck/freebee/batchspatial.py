...
commands1 = ['Rscript spatial_interpolation_part_1.R --args %s' % p 
             for p in paths]
commands2 = ['Rscript spatial_interpolation_part_2.R --args %s' % p 
             for p in paths]
commands = ['%s ; %s' % (commands1[i], commands2[i]) 
