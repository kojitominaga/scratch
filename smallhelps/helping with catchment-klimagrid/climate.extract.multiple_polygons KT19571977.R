...
dates.inn <- seq(from=as.Date('1957-01-01'), to=as.Date('1977-12-31'),
                 by='day')
...
write.table(rr, file = 'rr19571977.txt')
write.table(tm, file = 'tam19571977.txt')
...
write.table(m2, 'clim.out19571977.txt', row.names=FALSE)
