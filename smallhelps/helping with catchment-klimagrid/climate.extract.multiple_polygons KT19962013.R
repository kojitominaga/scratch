...
dates.inn <- seq(from=as.Date('1996-01-01'), to=as.Date('2013-12-31'),
                 by='day')
...
write.table(rr, file = 'rr19962013.txt')
write.table(tm, file = 'tam19962013.txt')
...
write.table(m2, 'clim.out19962013.txt', row.names=FALSE)
