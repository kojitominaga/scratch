...
dates.inn <- seq(from=as.Date('1978-01-01'), to=as.Date('1995-12-31'),
                 by='day')
...
write.table(rr, file = 'rr19781995.txt')
write.table(tm, file = 'tam19781995.txt')
...
write.table(m2, 'clim.out19781995.txt', row.names=FALSE)
